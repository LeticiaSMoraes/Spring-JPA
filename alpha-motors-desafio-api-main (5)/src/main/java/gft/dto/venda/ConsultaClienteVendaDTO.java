...
public class ConsultaClienteVendaDTO {
	
	private String nome;
	
	private List<ConsultaVendaDTO> consultaVendaDTOs;

	public ConsultaClienteVendaDTO() {
	}

	public ConsultaClienteVendaDTO(String nome, List<ConsultaVendaDTO> listaConsultaVendaDTO) {
		this.nome = nome;
